<nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
    <div class="container px-5">
        <a class="navbar-brand fw-bold" href="index.php"><img style="height: 80px;" src="assets/img/deduct-logo.png"
                alt="Deduct"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link me-lg-3" href="index.php#services">Services</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link me-lg-3" href="pricing.php">Pricing</a>
                </li>
                <?php
